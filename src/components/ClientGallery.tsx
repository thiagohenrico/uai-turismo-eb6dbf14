...
const ClientGallery = () => {
  const clientPhotos = [
    ...
    { src: client35, alt: "Grupo em Maragogi", location: "Maragogi Ponta de Mangue" },
    { src: client36, alt: "Família nas praias de São Miguel", location: "São Miguel dos Milagres" },
    { src: client37, alt: "Grupo de amigos em São Miguel", location: "São Miguel dos Milagres" },
    { src: client38, alt: "Casal em buggy", location: "Buggy Porto de Galinhas" },
    { src: client39, alt: "Grupo animado no buggy", location: "Buggy Porto de Galinhas" },
    { src: client40, alt: "Visitante no Ecopark", location: "Ecopark Maragogi" },
    { src: client41, alt: "Turistas na Ilha", location: "Ilha de Santo Aleixo" },
    { src: client42, alt: "Casal na Ilha de Santo Aleixo", location: "Ilha de Santo Aleixo" },
    { src: client43, alt: "Grupo na Ilha", location: "Ilha de Santo Aleixo" },
    { src: client44, alt: "Família em Maragogi", location: "Maragogi Barra Grande" },
