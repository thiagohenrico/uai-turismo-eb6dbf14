...
const ClientGallery = () => {
  const clientPhotos = [
    { src: client1, alt: "Cliente com cobra", location: "Ecopark Maragogi" },
    { src: client2, alt: "Cliente nas piscinas", location: "Porto de Galinhas" },
    { src: client3, alt: "Casal apaixonado", location: "Porto de Galinhas" },
    { src: client4, alt: "Amigos mergulhando", location: "Maragogi" },
    { src: client5, alt: "Casal com arara", location: "Porto de Galinhas" },
    { src: client6, alt: "Cliente em barco", location: "São Miguel dos Milagres" },
    { src: client7, alt: "Cliente feliz", location: "Porto de Galinhas" },
    { src: client8, alt: "Grupo especial", location: "Praia dos Carneiros" },
    { src: client9, alt: "Família reunida", location: "Praia dos Carneiros" },
    { src: client10, alt: "Casal no balanço", location: "Porto de Galinhas" },
    { src: client11, alt: "Cliente com pet", location: "Porto de Galinhas" },
    { src: client12, alt: "Grupo em buggys", location: "Buggy Porto de Galinhas" },
    { src: client13, alt: "Família com bebê", location: "Porto de Galinhas" },
    { src: client14, alt: "Cliente sorrindo", location: "Porto de Galinhas" },
    { src: client15, alt: "Grande grupo", location: "Maragogi Barra Grande" },
    { src: client16, alt: "Grupo na capela", location: "Praia dos Carneiros" },
    { src: client17, alt: "Casal em barco", location: "Praia dos Carneiros" },
    { src: client18, alt: "Cliente na boia", location: "Porto de Galinhas" },
    { src: client19, alt: "Família feliz", location: "Praia dos Carneiros" },
    { src: client20, alt: "Grupo no buggy", location: "Buggy Porto de Galinhas" },
    { src: client21, alt: "Família no mirante", location: "São Miguel dos Milagres" },
    { src: client22, alt: "Cliente em Olinda", location: "City Tour Recife e Olinda" },
    { src: client23, alt: "Casal relaxando", location: "Praia dos Carneiros" },
    { src: client24, alt: "Rua colorida", location: "City Tour Recife e Olinda" },
    ...
    { src: client27, alt: "Grupo no buggy", location: "Buggy Porto de Galinhas" },
    { src: client28, alt: "Cliente feliz", location: "Maragogi Ponta de Mangue" },
    { src: client29, alt: "Grupo com peixes", location: "Maragogi" },
    { src: client30, alt: "Grupo na praia", location: "Maragogi Barra Grande" },
    { src: client31, alt: "Grupo em Recife", location: "City Tour Recife e Olinda" },
    { src: client32, alt: "Cliente em barco", location: "Maragogi" },
    { src: client33, alt: "Família na praia", location: "Maragogi" },
    { src: client34, alt: "Criança feliz", location: "Maragogi" },
    ...
    { src: client37, alt: "Casal em barco", location: "Praia dos Carneiros" },
    { src: client38, alt: "Família reunida", location: "Praia dos Carneiros" },
    { src: client39, alt: "Grupo com guia", location: "Maragogi Barra Grande" },
    { src: client40, alt: "Grupo feliz", location: "Maragogi Barra Grande" },
    { src: client41, alt: "Família em Maragogi", location: "Maragogi Barra Grande" },
    { src: client42, alt: "Cliente sorrindo", location: "Maragogi Barra Grande" },
    { src: client43, alt: "Grupo reunido", location: "Maragogi Barra Grande" },
    { src: client44, alt: "Casal apaixonado", location: "Maragogi Ponta de Mangue" },
    { src: client45, alt: "Cliente na praia", location: "Praia dos Carneiros" },
    { src: client46, alt: "Grupo feliz", location: "Porto de Galinhas" },
    { src: client47, alt: "Cliente relaxando", location: "Porto de Galinhas" },
    { src: client48, alt: "Família reunida", location: "Maragogi" },
    { src: client49, alt: "Grupo animado", location: "Buggy Porto de Galinhas" },
    { src: client50, alt: "Cliente feliz", location: "São Miguel dos Milagres" },
    ...
    { src: client53, alt: "Grupo na praia", location: "Praia dos Carneiros" },
    { src: client54, alt: "Casal feliz", location: "Praia dos Carneiros" },
    { src: client55, alt: "Casal na capela", location: "Praia dos Carneiros" },
    { src: client56, alt: "Cliente sorrindo", location: "Praia dos Carneiros" },
    ...
    { src: client61, alt: "Criança feliz", location: "Maragogi Ponta de Mangue" },
    { src: client62, alt: "Casal relaxando", location: "Porto de Galinhas" },
    { src: client63, alt: "Família no mirante", location: "Porto de Galinhas" },
    { src: client64, alt: "Grupo animado", location: "City Tour Recife e Olinda" },
    { src: client65, alt: "Família com bebê", location: "Maragogi Ponta de Mangue" },
    { src: client66, alt: "Cliente em barco", location: "São Miguel dos Milagres" },
  ];
