...
const ClientGallery = () => {
  const clientPhotos = [
    { src: client1, alt: "Cliente feliz", location: "Ecopark Maragogi" },
    { src: client2, alt: "Cliente nas piscinas", location: "Porto de Galinhas" },
    { src: client3, alt: "Casal na praia", location: "Porto de Galinhas" },
    { src: client4, alt: "Amigos felizes", location: "Maragogi" },
    { src: client5, alt: "Casal com arara", location: "Porto de Galinhas" },
    { src: client6, alt: "Cliente no barco", location: "Praia dos Carneiros" },
    { src: client7, alt: "Cliente sorrindo", location: "Porto de Galinhas" },
    { src: client8, alt: "Grupo reunido", location: "Maragogi" },
    { src: client9, alt: "Família na praia", location: "Porto de Galinhas" },
    { src: client10, alt: "Casal se divertindo", location: "Porto de Galinhas" },
    ...
    { src: client14, alt: "Cliente feliz", location: "Maragogi" },
    ...
    { src: client30, alt: "Grupo reunido", location: "Maragogi Barra Grande" },
    ...
    { src: client45, alt: "Cliente em Carneiros", location: "Praia dos Carneiros" },
    { src: client46, alt: "Grupo na praia", location: "Porto de Galinhas" },
    { src: client47, alt: "Cliente com guarda-sol", location: "Porto de Galinhas" },
    { src: client48, alt: "Família reunida", location: "Maragogi" },
    { src: client49, alt: "Grupo feliz", location: "Buggy Porto de Galinhas" },
