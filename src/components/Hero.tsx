  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-32 text-center">
        <h1 className="font-script text-5xl md:text-7xl mb-6 text-foreground leading-tight">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          <div className="bg-secondary px-6 py-3 rounded-full">
            <span className="font-semibold text-secondary-foreground">CADASTUR - Empresa Credenciada</span>
          </div>
